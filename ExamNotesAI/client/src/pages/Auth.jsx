...
function Auth() {
  ...
  return (
    <div className='min-h-screen overflow-hidden bg-white text-black px-8'>
      ...
      px-8 py-6
      shadow-[0_28px_45px_rgba(0,0,0,0.6)]">
      ...
      items-center'>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 gap-8'>
          <Feature icon="🎁" title="50 Free Credits" des="Start with 50 credits to 
          generate notes without paying." />
          <Feature icon="📝" title="Exam Notes" des="High-yield, revision-ready 
          exam-oriented notes." />
          <Feature icon="📘" title="Project Notes" des="Well-structured documentation 
          for assignments & projects." />
          <Feature icon="📊" title="Charts & Graphs" des="Auto-generated diagrams, 
          charts and flow graphs." />
          <Feature icon="📄" title="Free PDF Download" des="Download clean, printable 
          PDFs instantly." />
