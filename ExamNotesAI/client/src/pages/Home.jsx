...
function Home() {
  ...
  return (
    <div className='min-h-screen overflow-hidden bg-white text-black'>
      ...
      lg:grid-cols-2 gap-20 items-center">
        <div>
          ...
          style={{ transformStyle: "preserve-3d"}}>
            ...
            bg-gradient-to-br from-black/90 via-black/60 to-black/90 bg-clip-text 
            text-transparent"
            whileHover={{ y: -4 }}
            style={{
              ...
              Generate Smart <br/> Notes Instantly with AI
            </motion.h1>
            <motion.p
            whileHover={{ y: -2 }}
      ...
      <section className="max-w-6xl mx-auto px-8 py-20 grid grid-cols-1 
